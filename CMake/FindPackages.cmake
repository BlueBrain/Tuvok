...
common_package(ZLIB 1.2  REQUIRED )
...
if(OpenMP_name)
  ...
  if(NOT COMMON_LIBRARY_TYPE MATCHES "SHARED")
    list(APPEND TUVOK_DEPENDENT_LIBRARIES OpenMP)
  endif()
...
if(ZLIB_name)
  ...
  if(NOT COMMON_LIBRARY_TYPE MATCHES "SHARED")
    list(APPEND TUVOK_DEPENDENT_LIBRARIES ZLIB)
  endif()
  ...
  if(NOT "${${ZLIB_name}_INCLUDE_DIR}" MATCHES "-NOTFOUND")
    include_directories(${${ZLIB_name}_INCLUDE_DIR})
  endif()
endif()
...
if(Qt5Core_name)
  list(APPEND FIND_PACKAGES_DEFINES TUVOK_USE_QT5CORE)
  if(NOT COMMON_LIBRARY_TYPE MATCHES "SHARED")
    list(APPEND TUVOK_DEPENDENT_LIBRARIES Qt5Core)
  endif()
...
if(Qt5OpenGL_name)
  list(APPEND FIND_PACKAGES_DEFINES TUVOK_USE_QT5OPENGL)
  if(NOT COMMON_LIBRARY_TYPE MATCHES "SHARED")
    list(APPEND TUVOK_DEPENDENT_LIBRARIES Qt5OpenGL)
  endif()
...
if(BISON_name)
  ...
  if(NOT COMMON_LIBRARY_TYPE MATCHES "SHARED")
    list(APPEND TUVOK_DEPENDENT_LIBRARIES BISON)
  endif()
  ...
  if(NOT "${${BISON_name}_INCLUDE_DIR}" MATCHES "-NOTFOUND")
    include_directories(${${BISON_name}_INCLUDE_DIR})
  endif()
endif()
...
if(FLEX_name)
  ...
  if(NOT COMMON_LIBRARY_TYPE MATCHES "SHARED")
    list(APPEND TUVOK_DEPENDENT_LIBRARIES FLEX)
  endif()
  ...
  if(NOT "${${FLEX_name}_INCLUDE_DIR}" MATCHES "-NOTFOUND")
    include_directories(${${FLEX_name}_INCLUDE_DIR})
  endif()
endif()
...
if(OpenGL_name)
  ...
  if(NOT COMMON_LIBRARY_TYPE MATCHES "SHARED")
    list(APPEND TUVOK_DEPENDENT_LIBRARIES OpenGL)
  endif()
...
set(TUVOK_BUILD_DEBS autoconf;automake;cmake;doxygen;git;git-review;libqt5opengl5-dev;pkg-config;subversion)

set(TUVOK_DEPENDS OpenMP;ZLIB;Qt5Core;Qt5OpenGL;BISON;FLEX;OpenGL)
